...
const HIS_CATALOG = Object.freeze([
  ...
  },
  {
    ...
    stackRole: 'DelegatedSupportRuntime',
    contributesToHisReadiness: false,
    lifecycleAuthority: 'Platform Delivery runtime owner',
    mode: 'HelmManaged',
    required: false,
    ...
    adoptExisting: true,
    replacementPolicy: {
      strategy: 'replace-runtime-preserve-declarations',
      confirmation: 'replace argocd-runtime',
      allowedKinds: [
        'Deployment',
        'StatefulSet',
        'Service',
    ...
    remediation: {
      ...
      steps: ['기존 비-Helm runtime은 계획에서 충돌 리소스를 식별하고 별도 교체 승인을 받은 뒤 Helm release로 전환합니다.', 'controller·repo-server·server·ApplicationSet readiness를 검증합니다.', 'Application/AppProject와 repository credential은 runtime 교체·제거 시에도 보존합니다.'],
  ...
  },
  {
    ...
    stackRole: 'DelegatedSupportRuntime',
    contributesToHisReadiness: false,
    lifecycleAuthority: 'Platform Support observability owner',
    mode: 'HelmManaged',
    required: false,
