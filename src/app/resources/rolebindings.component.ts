...
/** RoleBindings 목록 — /apis/rbac.authorization.k8s.io/v1/rolebindings. namespaced. */
@Component({
  selector: 'app-res-rolebindings',
  standalone: true,
  imports: [ResourceListComponent],
  template: `<app-resource-list title="Role Bindings" path="/apis/rbac.authorization.k8s.io/v1/rolebindings" [namespaced]="true" kind="RoleBinding" [columns]="cols" />`,
})
export class RoleBindingComponent {
  cols: ColumnDef[] = [
